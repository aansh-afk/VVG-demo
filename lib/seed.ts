...
const BOARD: BoardSeed[] = [
  {
    ...
    email: "chairman@wasl-global.org",
  ...
  },
  {
    ...
    email: "vice.chair@wasl-global.org",
  ...
  },
  {
    ...
    email: "treasurer@wasl-global.org",
  ...
  },
  {
    ...
    email: "marketing@wasl-global.org",
  ...
  },
  {
    ...
    email: "franchisee.affairs@wasl-global.org",
  ...
  },
  {
    ...
    email: "sourcing@wasl-global.org",
...
const EVENTS: EventSeed[] = [
  ...
  },
  {
    ...
    category: "Workshop",
    format: "in_person",
    venueEn: "WASL Global Academy, Olaya",
    venueAr: "أكاديمية وصل جلوبال، العليا",
    city: "Riyadh",
    country: "Saudi Arabia",
...
export async function buildSeed(): Promise<Database> {
  ...
  db.board = BOARD.map<BoardMember>((b) => ({
    ...
    email: b.email,
    phone: b.phone,
    linkedin: `https://www.linkedin.com/company/wasl-global`,
    country: b.country,
    initials: b.name
  ...
  const superAdmin: User = {
    id: id(),
    email: (process.env.SUPER_ADMIN_EMAIL || "admin@wasl-global.org").toLowerCase(),
  ...
  db.users.push({
    id: adminId,
    email: "events.admin@wasl-global.org",
    passwordHash: demoPw,
  ...
  EVENTS.forEach((e) => {
    ...
    const ev: CoopEvent = {
      ...
      capacity: e.capacity,
      feeSar: e.feeSar,
      contactEmail: "events@wasl-global.org",
      status: e.status,
      coverTone: e.tone,
